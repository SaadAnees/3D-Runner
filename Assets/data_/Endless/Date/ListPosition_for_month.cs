...
public class ListPosition_for_month : MonoBehaviour
{
    ...
    public static ListPosition_for_month Instance;
    ...
    /* Containers */
    public ListBox_formonth[] listBoxes;
    ...
    void storeMousePosition()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            foreach (ListBox_formonth listBox in listBoxes)
